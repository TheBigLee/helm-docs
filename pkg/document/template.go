...
func getHelmDocsVersionTemplates() string {
	...
	versionSectionBuilder.WriteString("Autogenerated from chart metadata using [helm-docs v{{ .HelmDocsVersion }}](https://github.com/TheBigLee/helm-docs/releases/v{{ .HelmDocsVersion }})")
